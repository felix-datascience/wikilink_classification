...
MODEL_FILEPATH = f"../data/model_results/{MODEL_NAME}/trained_model.pkl"
ENTITY_TO_ID_FILEPATH = f"../data/model_results/{MODEL_NAME}/training_triples/entity_to_id.tsv.gz"
RELATION_TO_ID_FILEPATH = f"../data/model_results/{MODEL_NAME}/training_triples/relation_to_id.tsv.gz"
